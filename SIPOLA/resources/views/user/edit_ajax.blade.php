                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="id_role" id="id_role" class="form-select" readonly>
                            @foreach($roles as $role)
                                <option value="{{ $role->id_role }}" {{ $role->id_role == $user->id_role ? 'selected' : '' }}>{{ $role->role_nama }}</option>
                            @endforeach
                        </select>
                    ...
                    @if($user->id_role == 3)
                        <div class="mb-3">
                            ...
                            <input value="{{ $user->nim }}" type="text" name="nim_nidn" id="nim_nidn" class="form-control">
                    ...
                    @elseif($user->id_role == 2)
                        <div class="mb-3">
                            ...
                            <input value="{{ $user->nidn }}" type="text" name="nim_nidn" id="nim_nidn" class="form-control">
                            <div id="error-nim_nidn" class="form-text text-danger"></div>
                        </div>
                    @endif
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response.status) {
                                ...
                                dataUser.ajax.reload(); // Pastikan ID datatable kamu sesuai
                            } else {
