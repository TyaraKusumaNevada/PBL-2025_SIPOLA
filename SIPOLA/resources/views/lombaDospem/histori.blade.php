                        ...
                        <div class="col-sm-12">
                            <div class="card-body min-vh-50 mb-5">
                                <div class="d-flex justify-content-between align-items-center mb-5">
                                    ...
                                    <a href="javascript:void(0);" onclick="modalAction('{{ url('/lombaDospem/create_ajax') }}')"
...
@push('js')
    <script>
        ...
        var dataHistoriDospem;
        $(document).ready(function() {
            dataHistoriDospem = $('#table_lomba').DataTable({
                serverSide: true,
                processing: true,
                ajax: {
                    url: "{{ url('lombaDospem/list') }}",
                    type: "POST",
                    dataType: "json",
                },
                columns: [{
